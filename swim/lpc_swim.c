...
**                                                                                              
***********************************************************************************************/
void swim_plot4points( SWIM_WINDOW_T *win, INT_32 cx, INT_32 cy, INT_32 x, INT_32 y, INT_32 Filled )
{
INT_16 x0, x1, y0, y1;
...
**                                                                                              
***********************************************************************************************/
void swim_plot8points( SWIM_WINDOW_T *win, INT_32 cx, INT_32 cy, INT_32 x, INT_32 y, INT_32 Filled )
{
